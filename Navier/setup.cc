...
{
  AssertThrow(2==2,ExcNotImplemented());
...
//   }
  ...
  // std::vector<Point<3> > fluid_face_centers, temp_structure_face_centers(structure_triangulation.n_active_cells());
  // std::vector<bool> temp_structure_interface_cells(structure_triangulation.n_active_cells());
  // std::vector<unsigned int> temp_structure_interface_faces(structure_triangulation.n_active_cells());
  // std::vector<Point<3> > structure_face_centers(fluid_interface_faces.size());
